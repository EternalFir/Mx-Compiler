...
public class Binary extends instruction {
    ...
    public Binary(Block block_in, register register_in, operand lhs_in, operand rhs_in, String op_in) {
    ...
    public String intoString() {
        return register.intoString() + " = " + op + " " + lhs.irType.intoString() + " " + lhs.intoString() + ", " + rhs.intoString();
    }
